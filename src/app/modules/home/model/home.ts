...
export type SocketEventTypes = 'ORDER_PLACED' | 'DELIVERY_ORDER_STATUS' | 'DELIVERY_RIDER_STATUS' | 'ORDER_CANCELLED' | 'RIDER_ORDER_REJECTED' | 'RIDER_ORDER_IGNORED' | 'RIDER_ORDER_ACCEPTED' | 'NEW_ORDER_INQUIRY' | 'CANCELLED_ORDER_INQUIRY'
